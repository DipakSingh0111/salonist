          ...
          <div className="sidebar">
            ...
            <div className="item">
              <a href="appointments.html" className="profile-link">
                <span className="icon-50">
                  <img src="/images/profile/calendar.svg" alt="Appointments" />
                </span>{" "}
                Appointments
              </a>
            </div>
            ...
            <div className="item">
              <a href="membership.html" className="profile-link">
                <span className="icon-50">
                  <img src="/images/profile/membership.svg" alt="membership" />
                </span>{" "}
                Membership
              </a>
            </div>
            <div className="item">
              <a href="favourites.html" className="profile-link">
                <span className="icon-50">
                  <img src="/images/profile/favourite.svg" alt="favourite" />
                </span>{" "}
                Favourites
              </a>
            </div>
            ...
            <div className="item">
              <a href="products.html" className="profile-link">
                <span className="icon-50">
                  <img src="/images/profile/products.svg" alt="products" />
                </span>{" "}
                Products Orders
              </a>
            </div>
            ...
            <div className="item">
              <a href="download.html" className="profile-link">
                <span className="icon-50">
                  <img src="/images/profile/download.svg" alt="Download" />
                </span>{" "}
                Download
              </a>
            </div>
            <div className="item">
              <a href="customer-support.html" className="profile-link">
                <span className="icon-50">
                  <img src="/images/profile/support.svg" alt="Customer Support" />
                </span>{" "}
                Customer Support
              </a>
            </div>
